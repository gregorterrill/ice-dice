...
var gameFilters = document.getElementById('game-filters');
var searchInput = document.getElementById('search');
var autocompleteResults = document.getElementById('search-autocomplete-results');
var focusedResult = -1;
var handleInput = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var query, li, body, request, response, i, _response$i$url, highlightedTitle, queryIntersection;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 6:
          _context.next = 8;
          return fetch("/actions/supersearch/search/get-search-results", {
...
searchInput.addEventListener('keydown', function (e) {
  var results = autocompleteResults.getElementsByTagName('li');
  if (e.key == 'ArrowDown') {
    focusedResult++;
...
/******/ 		var installedChunks = {
/******/ 			"/web/dist/js/global": 0,
/******/ 			"web/dist/css/styles": 0
/******/ 		};
/******/ 		
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkice_dice"] = self["webpackChunkice_dice"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["web/dist/css/styles"], () => (__webpack_require__("./src/global.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["web/dist/css/styles"], () => (__webpack_require__("./src/styles.css")))
